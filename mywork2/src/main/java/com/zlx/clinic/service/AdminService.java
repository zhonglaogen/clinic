...
import com.zlx.clinic.mymapper.MyAdminMapper;
...
public class AdminService {
    ...
    public boolean arrangeQueue(String phone, Admin admin) throws Exception {
        ...
        //查询是否当日有此人预约此科室,是否已经排过号
        MyArrange myArrange = myAdminMapper.findOrderByPhoneDate(new MyArrangeMessage(date, phone, room.getrId()));
        Boolean aBoolean = myArrange.getPatientOrder().getoGo();
        if (myArrange != null && !aBoolean) {
            //将预约单的排号状态改为true
